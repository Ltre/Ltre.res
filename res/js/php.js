...
var $php = {};
$php.XMLHttpRequest = {};
$php.window = {window: {},document: {lastModified: 1388954399,getElementsByTagName: function(){return [];}},location: {href: ""}};
$php.window.window = $php.window;
...
$php.array_change_key_case = function (array, cs) {
...
$php.array_chunk = function (input, size, preserve_keys) {
  var x, p = '',
      i = 0,
      c = -1,
      l = input.length || 0,
...
$php.array_count_values = function (array) {
  var tmp_arr = {},
      key = '',
      t = '';
...
$php.array_diff_assoc = function (arr1) {
  var retArr = {},
      argl = arguments.length,
      k1 = '',
      i = 1,
...
$php.array_diff_key = function (arr1) {
...
$php.array_diff_uassoc = function (arr1) {
  var retArr = {},
...
$php.array_diff_ukey = function (arr1) {
  var retArr = {},
      arglm1 = arguments.length - 1,
      cb = arguments[arglm1],
      arr = {},
...
$php.array_intersect = function (arr1) {
  var retArr = {},
      argl = arguments.length,
      arglm1 = argl - 1,
      k1 = '',
...
$php.array_intersect_assoc = function (arr1) {
  var retArr = {},
      argl = arguments.length,
      arglm1 = argl - 1,
      k1 = '',
...
$php.array_intersect_key = function (arr1) {
  var retArr = {},
      argl = arguments.length,
      arglm1 = argl - 1,
      k1 = '',
...
$php.array_intersect_uassoc = function (arr1) {
  var retArr = {},
      arglm1 = arguments.length - 1,
      arglm2 = arglm1 - 1,
      cb = arguments[arglm1],
...
$php.array_intersect_ukey = function (arr1) {
  var retArr = {},
      arglm1 = arguments.length - 1,
      arglm2 = arglm1 - 1,
      cb = arguments[arglm1],
...
$php.array_multisort = function (arr) {
...
$php.array_replace_recursive = function (arr) {
  var retObj = {},
      i = 0,
      p = '',
      argl = arguments.length;
...
$php.array_udiff_assoc = function (arr1) {
  var retArr = {},
      arglm1 = arguments.length - 1,
      cb = arguments[arglm1],
      arr = {},
...
$php.array_udiff_uassoc = function (arr1) {
  var retArr = {},
      arglm1 = arguments.length - 1,
      arglm2 = arglm1 - 1,
      cb = arguments[arglm1],
...
$php.array_uintersect = function (arr1) {
  var retArr = {},
      arglm1 = arguments.length - 1,
      arglm2 = arglm1 - 1,
      cb = arguments[arglm1],
...
$php.array_uintersect_assoc = function (arr1) {
  var retArr = {},
      arglm1 = arguments.length - 1,
      arglm2 = arglm1 - 2,
      cb = arguments[arglm1],
...
$php.array_uintersect_uassoc = function (arr1) {
  var retArr = {},
      arglm1 = arguments.length - 1,
      arglm2 = arglm1 - 1,
      cb = arguments[arglm1],
...
$php.gettimeofday = function (return_float) {
  var t = new Date(),
      y = 0;
...
$php.idate = function (format, timestamp) {
  if (format === undefined) {
...
$php.create_function = function (args, code) {
  try {
...
$php.function_exists = function (func_name) {
...
$php.i18n_loc_set_default = function (name) {
  // BEGIN REDUNDANT
    this.php_js = this.php_js || {};
    // END REDUNDANT
...
$php.assert_options = function (what, value) {
  // BEGIN REDUNDANT
    this.php_js = this.php_js || {};
    this.php_js.ini = this.php_js.ini || {};
...
$php.json_decode = function (str_json) {
  /*
...
$php.json_encode = function (mixed_val) {
  /*
      http://www.JSON.org/json2.js
      2008-11-19
      Public Domain.
...
$php.atan = function (arg) {
  return Math.atan(arg);
};

$php.atan2 = function (y, x) {
...
$php.exp = function (arg) {
  return Math.exp(arg);
};

$php.expm1 = function (x) {
  var ret = 0,
...
$php.sqrt = function (arg) {
  return Math.sqrt(arg);
};

$php.tan = function (arg) {
  return Math.tan(arg);
};
...
$php.time_sleep_until = function (timestamp) {
...
$php.gopher_parsedir = function (dirent) {
  /* Types
     * 0 = plain text file
...
$php.convert_cyr_string = function (str, from, to) {
  var _cyr_win1251 = [
...
$php.count_chars = function (str, mode) {
  var result = {},
      resultArr = [],
      i;
...
$php.echo = function () {
  var isNode = typeof module !== 'undefined' && module.$php && typeof global !== "undefined" && {}.toString.call(global) == '[object global]';
    if (isNode) {
      var args = Array.prototype.slice.call(arguments);
...
$php.levenshtein = function (s1, s2) {
  if (s1 == s2) {
      return 0;
    }
...
$php.metaphone = function (word, max_phonemes) {
...
$php.quoted_printable_encode = function (str) {
...
$php.similar_text = function (first, second, percent) {
...
$php.sscanf = function (str, format) {
  // SETUP
    var retArr = [],
      num = 0,
      _NWS = /\S/,
...
$php.strrchr = function (haystack, needle) {
  var pos = 0;
...
$php.strspn = function (str1, str2, start, lgth) {
  var found;
    var stri;
    var strj;
    var j = 0;
...
$php.floatval = function (mixed_var) {
...
$php.xdiff_string_diff = function (old_data, new_data, context_lines, minimal) {
...
$php.xdiff_string_patch = function (originalStr, patch, flags, error) {
...
$php.bcadd = function (left_operand, right_operand, scale) {
...
$php.bccomp = function (left_operand, right_operand, scale) {
  var libbcmath = this._phpjs_shared_bc();
...
$php.bcdiv = function (left_operand, right_operand, scale) {
  var libbcmath = this._phpjs_shared_bc();
...
$php.bcmul = function (left_operand, right_operand, scale) {
  var libbcmath = this._phpjs_shared_bc();
...
$php.bcround = function (val, precision) {
  var libbcmath = this._phpjs_shared_bc();
...
$php.bcsub = function (left_operand, right_operand, scale) {
  var libbcmath = this._phpjs_shared_bc();
...
$php.convert_uuencode = function (str) {
  var chr = function(c) {
...
$php.htmlentities = function (string, quote_style, charset, double_encode) {
...
$php.vprintf = function (format, args) {
  var body, elmt;
    var ret = '',
      d = this.window.document;
...
$php.get_headers = function (url, format) {
  var req = this.window.ActiveXObject ? new ActiveXObject('Microsoft.XMLHTTP') : new XMLHttpRequest();
...
$php.get_meta_tags = function (file) {
  var fulltxt = '';
...
$php.doubleval = function (mixed_var) {
...
$php.is_double = function (mixed_var) {
  return this.is_float(mixed_var);
};

$php.is_integer = function (mixed_var) {
...
$php.var_export = function (mixed_expression, bool_return) {
  var retstr = '',
      iret = '',
      value,
      cnt = 0,
...
$php.strptime = function (dateStr, format) {
...
$php.strcoll = function (str1, str2) {
  this.setlocale('LC_ALL', 0); // ensure setup of localization variables takes place
